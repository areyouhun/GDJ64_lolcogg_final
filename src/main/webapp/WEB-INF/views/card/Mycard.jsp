		...
		<div class="center-1280 background-img mainpage mainHeight">
			<div class="width-1280 ">
				<div class="card_main_size">
					<div class="card_catalog">
						<a href="${path }/card/selectCardById"><span class="content" onclick="">MY CARD</span></a> 
						<a><span class="content">CARD CATALOG</span></a> 
						<a><span class="content">ACHIEVEMENT</span></a> 
					...
					<c:set var="leader_cardName2" value="${fn:toLowerCase(leader_cardName1)}" />
                          ...
                          <div class="back">
                            <div class="back-content">
                              ...
                              <div class="card_info_div">
                                <strong>
                                  <img src="${path }/resources/images/card/${l.card.cardClass.cardClassName }.png" alt="" width="250px" height="350px" class="player_img">
                                </strong>
                                <div class="card_player_info">
                                  ...
                                  <img src="${path }/resources/images/player/${l.card.teamName}_roster_${leader_cardName2 }1.png" alt="" class="player" width="170px" height="250px">
                                  <img src="${path }/resources/images/logo/${l.card.teamName }_logo_small.png" class="player_team_logo" width="45px"
                                    height="25px">
                                  <img src="${path }/resources/images/card/${l.card.cardPosition }.svg" alt="" class="player_position_img" width="20px" height="20px">
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <div class="card_info">
              <div class="card_img_name">
                <img src="${path }/resources/images/logo/${l.card.teamName }_logo_small.png" alt="" width="60px" height="25px">
                <span class="title">${l.card.cardName }</span>
              </div>
              <hr>
              ...
              <div class="rader_ability_div">
                ...
                <div class="card_info_ability_div">
                  <div class="card_info_ability">
                    <img src="${path }/resources/images/card/BATTLE.png" alt="" width="25px">
                    <span class="title">공격</span>
                  ...
                  <div class="card_info_ability">
                    <img src="${path }/resources/images/card/DEFEND.png" alt="" width="25px">
                    <span class="title">수비</span>
                  ...
                  <div class="card_info_ability">
                    <img src="${path }/resources/images/card/SURVIVAL.png" alt="" width="25px">
                    <span class="title">생존</span>
                  ...
                  <div class="card_info_ability">
                    <img src="${path }/resources/images/card/GROWTH.png" alt="" width="25px">
                    <span class="title">성장</span>
                  ...
                  <div class="card_info_ability">
                    <img src="${path }/resources/images/card/ASSISTANT.png" alt="" width="25px">
                    <span class="title">어시</span>
					...
					<div class="select_card">
						<div class="select_refresh_div">
							...
							<select class="Initialization select_button_player">
	                ...
	                success: function (cardList) {
			        	...
			        	if (cardList.length==0) {
			        	    ...
			        	    cardList.forEach(c => {
			        	        ...
			        	        html += '<span class="title title1">공격';
			        	        html += '</span>';
			        	        html += '<div class="graph1 front_stack">';
			        	        html += '<span style="width:'+ c.card.cardBattleAbility + '%;">';
			        	        html += '</span>';
			        	        html += '</div>';
			        	        html += '<span class="title title1 front_ability_size">'+c.card.cardBattleAbility+'%</span>';
			        	        ...
			        	        html += '<span class="title title1">수비';
			        	        html += '</span>';
			        	        html += '<div class="graph1 front_stack1">';
			        	        html += '<span style="width: '+c.card.cardDefendAbility+'%;">';
			        	        html += '</span>';
			        	        html += '</div>';
			        	        html += '<span class="title title1 front_ability_size">'+c.card.cardDefendAbility+'%';
			        	        ...
			        	        html += '<span class="title title1">생존';
			        	        html += '</span>';
			        	        html += '<div class="graph1 front_stack2">';
			        	        html += '<span style="width: '+c.card.cardsurvivalAbility+'%;">';
			        	        html += '</span>';
			        	        html += '</div>';
			        	        html += '<span class="title title1 front_ability_size">'+c.card.cardsurvivalAbility+'%';
			        	        ...
			        	        html += '<span class="title title1">성장';
			        	        html += '</span>';
			        	        html += '<div class="graph1 front_stack3">';
			        	        html += '<span style="width: '+c.card.cardGrowthAbility+'%;">';
			        	        html += '</span>';
			        	        html += '</div>';
			        	        html += '<span class="title title1 front_ability_size">'+c.card.cardGrowthAbility+'%';
			        	        ...
			        	        html += '<span class="title title1">어시';
			        	        html += '</span>';
			        	        html += '<div class="graph1 front_stack4">';
			        	        html += '<span style="width: '+c.card.cardAssistantAbility+'%;">';
			        	        html += '</span>';
			        	        html += '</div>';
			        	        html += '<span class="title title1 front_ability_size">'+c.card.cardAssistantAbility+'%';

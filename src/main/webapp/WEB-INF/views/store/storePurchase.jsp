...
<script type="module">
			...
			const table = [
				'abc', 'Hydrogen', '1.00794', 1, 1,
				'bbc', 'Helium', '4.002602', 3, 1,
				'노말카드등급', 'Lithium', '6.941', 5, 1,
				'유니크 카드 등급', 'Helium', '4.002602', 7, 1,
				'Group 300', 'Lithium', '6.941', 9, 1,
				'Group 300', 'Hydrogen', '1.00794', 1, 3,
				'노말카드등급', 'Helium', '4.002602', 3, 3,
				'Group 300', 'Lithium', '6.941', 5, 3,
				'유니크 카드 등급', 'Helium', '4.002602', 7, 3,
				'Group 300', 'Lithium', '6.941', 9, 3,
			];
			...
			function init() {
				...
				for ( let i = 0; i < table.length; i += 5 ) {
					...
					const element = document.createElement( 'div' );
					element.className = 'element';
					// element.style.backgroundColor = 'rgba(255,21,17,' + ( Math.random() * 0.5 + 0.25 ) + ')';
					...
					const img = document.createElement( 'img' );
					img.setAttribute("src", "../img/"+table[ i ]+".png");
					img.setAttribute("width", "214");
					img.setAttribute("height", "318");
					element.appendChild( img );
					...
					// details.innerHTML = table[ i ] + '<br>'+table[ i + 1 ] + '<br>' + table[ i + 2 ];
					...
					const object = new THREE.Object3D();
					object.position.x = ( table[ i + 3 ] * 140 ) - 650;
					object.position.y = - ( table[ i + 4 ] * 180 ) + 390;
